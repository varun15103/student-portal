...
Saved records will go under `data/` (students, courses, enrollments, settings). The portal can also **export** those files for backup. Do not commit generated `build/` output; it is ignored.
